    ...
    public partial class allTablesAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teachers_Groups", x => new { x.TeacherId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_Teachers_Groups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teachers_Groups_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_Groups_GroupId",
                table: "Teachers_Groups",
                column: "GroupId");
